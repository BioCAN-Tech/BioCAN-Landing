          ...
          <div className="glass-card p-8 md:p-12 rounded-2xl">
            <div className="prose prose-invert max-w-none">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white mb-4">4. AI and Machine Learning Data Usage</h2>
                  <p className="text-gray-300 leading-relaxed mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white mb-4">7. Your Privacy Rights and Choices</h2>
                  <p className="text-gray-300 leading-relaxed mb-4">
